...
function startTerminal() {
  ...
  const shellCmds = {
    ...
    about: () => [
      ...
      { t: 'output', v: '  Software Engineer @ Hiteck Solutions' },
      ...
      { t: 'output', v: '  Currently deployed at Verizon, migrating data at scale.' },
    ],
    skills: () => [
      { t: 'amber', v: '> ls ~/skills/' },
      { t: 'output', v: '' },
    ...
    experience: () => [
      ...
      { t: 'output', v: '' },
      { t: 'success', v: '  NOW   Software Engineer — Hiteck Solutions' },
      { t: 'output',  v: '          ├─ Client: Verizon (Aug 2024 — Present)' },
      { t: 'output',  v: '          ├─ Client: NY State IT (Feb — Jul 2024)' },
      { t: 'output',  v: '          └─ Internal (Aug 2023 — Jan 2024)' },
